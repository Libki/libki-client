...
public:
  ...
  static SData new_node(const QString& server, const QString& node_name, const QString& version, const QString& age_limit);
  static SData new_nodepower(const QString& action);
  static SData new_printer(const QString& printer_name, const QString& printer_path);
